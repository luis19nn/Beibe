 ...
 * @author luis
 */
public class EMigrationTableCidade {
    private static Connection con = null;
    private static final String createTableCidade = "create table cidade(\n" +
"	id int,\n" +
"	nome varchar(100),\n" +
"	idEstado int,\n" +
...
");";
    ...
    public static void main(String[] args) throws SQLException, IOException {
        try{
            ...
            if(con.createStatement().executeUpdate(createTableCidade) != -1){
                System.out.println("Migration Cidade criada com sucesso!");
            }
    ...
    private final String insert1 = "INSERT INTO cidade (id, nome, idestado) VALUES\n" +
"(1, 'Afonso Cláudio', 8),\n" +
...
"(2067, 'Morada Nova de Minas', 11)";
    ...
    private final String insert2 = "INSERT INTO cidade (id, nome, idestado) VALUES\n" +
...
"(3976, 'Cruzeiro do Sul', 23)";
    ...
    private final String insert3 = "INSERT INTO cidade (id, nome, idestado) VALUES\n" +
