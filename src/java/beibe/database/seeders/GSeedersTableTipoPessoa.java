 ...
 * @author luis
 */
public class GSeedersTableTipoPessoa {
    private static Connection con = null;
    private static final String insertIntoTablePessoa = "insert into tipopessoa (descricao) "
            + "values ('Cliente'), ('Funcionário'), ('Gerente')";
