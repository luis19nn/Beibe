                            ...
                            <div id="login-box" class="col-md-12">
                                <form id="login-form" class="form" action="" method="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="categoria" class="form-control" value="${param.situacaoatendimento}" disabled>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label for="categoria" class="text-success">Categoria do Produto:</label><br>
                                                <input type="text" name="categoria" class="form-control"value="${param.categoria}" disabled>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="produto" class="text-success">Produto:</label><br>
                                                <input type="text" name="produto" class="form-control" value="${param.produto}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="tipoatendimento" class="text-success">Tipo do Atendimento:</label><br>
                                        <input type="text" name="tipoatendimento" class="form-control" value="${param.tipoatendimento}" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="descicao" class="text-success">Descrição:</label><br>
                                        <textarea name="descicao" id="descicao" cols="30" rows="10" class="form-control" disabled>${param.descricao}</textarea>
                                    </div>
                                    <div class="form-group">
