        ...
        <body>
            ...
            <div id="login" style="margin-top: 6%; margin-bottom: 6%;">
                <div class="container">
                    <div id="login-row" class="row justify-content-center align-items-center table-hover">
                        <div id="login-column" class="col-md-12">
                            <div id="login-box" class="col-md-12">
                                <h3 class="text-center text-success">Todos os Atendimentos</h3><br>
                                                ...
                                                <tbody>
                                                    <c:forEach var="atendimento" items="${requestScope.atendimentos}" varStatus="status">
                                                        ...
                                                        <c:set var="situacao" scope="request" value="${atendimento.situacaoAtendimento.descricao}"/>
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${situacao eq 'Aberto'}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a href="${pageContext.request.contextPath}/FuncionarioServlet?acao=listaatendimentoaberto" class="text-info" style="position: absolute; left: 35px;">Voltar</a>
                        </div>
                    </div>
                </div>
            </div>
