<%-- 
    Document   : cadastrofuncionariosgerentes
    Created on : 27 de abr de 2022, 17:50:52
    Author     : luis
--%>
                ...
                <div id="login-row" class="row justify-content-center align-items-center">
                    <div id="login-column" class="col-md-6">
                        <div id="login-box" class="col-md-12">
                            ...
                            <form id="login-form" class="form" action="${pageContext.request.contextPath}/GerenteServlet?acao=salvarcadastrofuncionario" method="post">
                                <h3 class="text-center text-success">Cadastrar Funcionário</h3>
                                <p class="text-danger">${requestScope.preenchimentoIncompleto}</p>
                                <div class="form-group">
                                    <label for="username" class="text-success">Nome:</label><br>
                                    <input type="text" name="nome" id="username" class="form-control" value="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="passwordconfirm" id="password-confirm" class="form-control" value="">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="complemento" id="complementp" class="form-control" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <a href="${pageContext.request.contextPath}/GerenteServlet?acao=paginainicial" class="text-info">Voltar</a>
                                    <input type="submit" name="submit" class="btn btn-success btn-md" value="Cadastrar" style="position: absolute; right: 15px;">
                                </div>
                            </form>
                        </div>
                    </div>
