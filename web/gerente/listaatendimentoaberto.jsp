<%-- 
    Document   : listaatendimentoaberto
    Created on : 30 de abr de 2022, 13:08:01
    Author     : luis
--%>
...
<html>
    <head>
        ...
        <title>Lista Atendimentos em Aberto</title>
        <!-- Bootstrap CSS -->
                ...
                <div id="login-row" class="row justify-content-center align-items-center">
                    <div id="login-column" class="col-md-12">
                        <div id="login-box" class="col-md-12">
                            <h3 class="text-center text-success">Lista de Atendimentos em Aberto</h3><br>
                            <div>
                            </div>
                            <br>
